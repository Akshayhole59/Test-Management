...
public class QuestionControllerTest {
	...
	public void testGetAllQuestions() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.get("/api/questions")).andExpect(status().isOk())
	...
	public void testGetQuestionById() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.get("/api/questions/{id}", questionId)).andExpect(status().isOk())
	...
	public void testCreateQuestion() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.post("/api/questions").contentType(MediaType.APPLICATION_JSON)
	...
	public void testDeleteQuestion() throws Exception {
		...
		when(questionService.getQuestionById(questionId)).thenReturn(
				new Question(questionId, "Question", "Option 1", "Option 2", "Option 3", "Option 4", "Answer", 10));

		mockMvc.perform(MockMvcRequestBuilders.delete("/api/questions/{id}", questionId)).andExpect(status().isOk());
